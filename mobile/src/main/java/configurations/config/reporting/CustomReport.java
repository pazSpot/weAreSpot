...
// * </p>
// */
//public class CustomReport extends MyReporterListenerAdapter implements IReporter {
...
//    private static final SimpleDateFormat TIME_FORMAT = new SimpleDateFormat("HH:mm:ss a");
//    private static final String outFilename = "custom-report.html";
...
//    public static ITestResult aResult = null;
...
////            System.log.info(externalDirectory);
////            writer = createWriter(externalDirectory);
//        } catch (IOException e) {
//            try {
...
//        writer.print("<head>");
//        writer.print("<title>" + System.getProperty("testType") + "</title>");
//        writeStylesheet();
//        writer.print("</head>");
//    }
//
...
//        writer.print("<body>");
//        if (System.getProperty("webOrMobileWeb").equals("web")) {
//            writeReportTitle(System.getProperty("brand") + " | " + System.getProperty("os") + " | " +System.getProperty("os_version") + " | " +System.getProperty("browser") + " | " +System.getProperty("browser_version") + " | " +System.getProperty("environment"));
//        }else{
//            writeReportTitle(System.getProperty("brand") + " | " + System.getProperty("device") + " | " +System.getProperty("os_version") + " | " +System.getProperty("environment"));
//        }
//        writeSuiteSummary();
...
//            writer.print("<tr><th colspan=\"5\">"); //All Tests - Passed
...
//
//
//                    String testStatus = String.valueOf(aResult.isSuccess());
//                    if (testStatus.equals("true")) {
//                        testStatus = "Passed";
//                    } else if (testStatus.equals("false")) {
//                        testStatus = "Failed";
//                    } else {
//                        testStatus = "Skipped";
//                    }
//
//                    // Write the timing information with the first scenario per method - Method name with a link
//                    buffer.append("<td><a href=\"#m").append(scenarioIndex)
//                            .append("\">").append(methodName + "</a></td>")
//                            .append("<td rowspan=\"1\">" + testStatus + "</td>") //Description
//                            .append("<td rowspan=\"")
//                            .append(resultsCount).append("\">").append(parseUnixTimeToTimeOfDay(start)) //Start
//                            .append("</td>").append("<td rowspan=\"")
//                            .append(resultsCount).append("\">")
////                            .append(decimalFormat.format(millisecondsToSeconds(duration)))
//                            .append("</td></tr>"); //Seconds
//                    scenarioIndex++;
//
//                    // Write the remaining scenarios for the method
//                    for (int i = 1; i < resultsCount; i++) {
//                        buffer.append("<tr class=\"").append(cssClass)
//                                .append("\">").append("<td><a href=\"#m") //Method name
...
//                writer.print("\">");
////                writer.print("<td rowspan=\""); //class name - no need
