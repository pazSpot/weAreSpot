...
//
////    private static final String reportBaseLocation = "\\\\TLVWS21203\\lmt\\jenkins_reports\\";
////    private static final String reportBaseLocation = "\\\\tlvfs\B2C\TestReports\\";
//    // ~ Methods --------------------------------------------------------------
//
//
//
...
//                               String outdir) {
//        try {
//            m_out = createWriter(outdir);//For default custom report generation
////            System.out.println(reportBaseLocation);
////            m_out = createWriter(reportBaseLocation); //For external custom report generation
//        } catch (IOException e) {
//            try {
//                L.error("output file");
//            } catch (Exception e1) {
...
//                + "<th>Method & Description</th><th># of<br/>Scenarios</th><th>Start Time</th><th>Run Time<br/>(ms)</th></tr>");
//        m_row = 0;
//    }
//
...
//        if (length > 0 && !"basicAccount".equalsIgnoreCase(groups[0])) {
//            addon.append("(");
...
//                    m_out.println(Utils.escapeHtml(Utils.toString(p)) + " | " + newLine);
//                }
//            }
//
//        }
...
//                // NEW
//                summaryCell(
//                        String.valueOf(DateFunctions.dateToDayAndTime(overview.getStartDate())),
//                        true);
//                m_out.println("</td>");
//                summaryCell(
//                        String.valueOf(DateFunctions.dateToDayAndTime(overview.getEndDate())),
//                        true);
//                m_out.println("</td>");
//
...
//        out.println("<head>");
//        out.println("<title>TGS - TestNG report</title>");
...
//        out.println("<center> report customized by Eyal Sooliman </center>");
